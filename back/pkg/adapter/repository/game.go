...
func (gr *gamerepository) FindGame(ctx context.Context, name string) ([]*model.Game, error) {
	query := "FOR game IN game FILTER LOWER(game.name) LIKE CONCAT('%', LOWER('" + name + "'), '%') RETURN game"
