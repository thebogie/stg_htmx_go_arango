...
func (uu userUsecase) GetPlayer(ctx context.Context, player model.InputUserData) (*model.UserData, error) {
	playerFound, _ := uu.userRepository.GetPlayerByEmail(ctx, player.Email)
